...
export const ACHIEVEMENT_CONFIG = [
  { key: "contributionClub" as const, label: "Contribution Club", icon: "Trophy", color: "#FFD700", maxValue: 5 },
  { key: "contributionNational" as const, label: "Contribution National", icon: "Earth", color: "#1B5E20", maxValue: 2 },
...
export const ACHIEVEMENT_LABELS: Record<string, string> = {
  contributionClub: "Contribution Club",
  contributionNational: "Contribution National",
  worldCup: "World Cup",
